...
require('./agam.js')
nocache('./agam.js', module => console.log(`${module} is now updated!`))

const starts = async (hexa = new WAConnection()) => {
    hexa.logger.level = 'warn'
    hexa.version = [2, 2123, 8]
    hexa.browserDescription = [ 'KamiKaze~', 'Chrome', '3.0' ]
    console.log(banner.string)
    hexa.on('qr', () => {
        console.log(color('[','white'), color('!','red'), color(']','white'), color(' Qr Siap Di Scan'))
    })
